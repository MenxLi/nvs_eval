...
from models.gsplat.examples.datasets.traj import (
...
from models.gsplat.examples.utils import AppearanceOptModule, CameraOptModule, knn, rgb_to_sh, set_random_seed
...
class Runner:
    ...
    def __init__(
        ...
        if cfg.use_bilateral_grid:
            raise NotImplementedError("Bilateral grid is not implemented yet.")
